...
class CtpGateway(VtGateway):
    ...
    def __init__(self, eventEngine, gatewayName='CTP'):
        ...
        self.fileName_other = self.gatewayName + '_other_connect.json'        
    ...
    def connect(self):
        ...
        self.initQuery()
    #----------------------------------------------------------------------     
    def connectAnother(self,fileName):
        ...
        self.mdApi.connect(userID, password, brokerID, mdAddress)
        self.tdApi.connect(userID, password, brokerID, tdAddress, authCode, userProductInfo)
        print "user:", userID , " login successful"
        # 初始化并启动查询
        self.initQuery()    
    #----------------------------------------------------------------------     
    def connectJson(self,userID, password , brokerID,tdAddress,mdAddress,authCode = None,userProductInfo = None):
